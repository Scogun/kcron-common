...
kotlin {
    sourceSets {
        commonMain {
            dependencies {
                implementation 'com.ucasoft.kcron:kcron-common:0.6.3'
            }
        }
    }
}
...
``` 
### Current status
This library is on beta version `0.6.3`.
