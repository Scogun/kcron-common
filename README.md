...
kotlin {
    sourceSets {
        commonMain {
            dependencies {
                implementation 'com.ucasoft.kcron:kcron-common:0.3.1'
            }
        }
    }
}
...
``` 
### Current status
This library is on alpha version `0.3.1`.
