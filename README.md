...
[![Maven Central with version prefix filter](https://img.shields.io/maven-central/v/com.ucasoft.kcron/kcron-common/0.1.4)](https://search.maven.org/artifact/com.ucasoft.kcron/kcron-common/0.1.4/jar)
...
kotlin {
    sourceSets {
        commonMain {
            dependencies {
                implementation 'com.ucasoft.kcron:kcron-common:0.1.4'
            }
        }
    }
}
...
``` 
### Current status
This library is on alpha version `0.1.4`.
