...
kotlin {
    sourceSets {
        commonMain {
            dependencies {
                implementation 'com.ucasoft.kcron:kcron-common:0.5.0'
            }
        }
    }
}
...
``` 
### Current status
This library is on beta version `0.5.0`.
